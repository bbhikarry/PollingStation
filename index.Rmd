...
library(readr)
large1a <- read.csv("sheets/largeSheet1.csv", header=TRUE, stringsAsFactors=FALSE, nrows= 18, col.names=c("PROPERTY", "", "","REPRESENTATIVE","", "","","","",""))
lgh = large1a[c(1, 4)]
print(lgh)
```
]
...
```{r echo = FALSE, message=TRUE, warning=TRUE, paged.print=TRUE}
library(readr)
large1b <- read.csv("sheets/largeSheet1.csv", stringsAsFactors=TRUE, skip=19, nrows=19, encoding= 'utf-8', header=FALSE, col.names=c("PROPERTY", "", "","REPRESENTATIVE","", "","","","",""))
