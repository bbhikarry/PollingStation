...
## About the available positions (overview)
...
A [label='Nominations for Pres', shape = invhouse, fontname= Helvetica]; 
B [label= 'Whiteboard', shape = box,fontname= Helvetica]; 
C [label='Results whiteboarded', shape = box, fontname= Helvetica]; 
D [label= 'Repeat for VP', shape = invhouse, fontname= Helvetica]; 
G [label='Poll (Google Form)', shape= tab, fontname= Helvetica  ]; 
H [label='Congratulations', shape= signature, fontname= Helvetica]; 
...
## Nominations Marine Sector  (Sample slide)
