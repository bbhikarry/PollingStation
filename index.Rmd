...
library(readr)
large1a <- read.csv("sheets/largeSheet1.csv", header=TRUE, stringsAsFactors=FALSE, nrows= 18)
lgh = large1a[c(1, 4)]
print(lgh)
...
```{r echo = FALSE, message=TRUE, warning=TRUE, paged.print=TRUE}
library(readr)
large1b <- read.csv("sheets/largeSheet1.csv", header=TRUE, stringsAsFactors=FALSE, skip=18, nrows=19)
jkl = large1b[c(1, 4)]
print(jkl)
