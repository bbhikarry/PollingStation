...
B [label= 'Whiteboard', shape = box,fontname= Helvetica, fontsize=20]; 
C [label='Results whiteboarded', shape = box, fontname= Helvetica, fontsize=20]; 
D [label= 'Repeat for other appointments', shape = invhouse, fontname= Helvetica, fontsize=20]; 
G [label='Poll (Google Form)', shape= tab, fontname= Helvetica, fontsize=20]; 
