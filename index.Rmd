...
## Before we begin:
  ...
  - These pages are slides. The Left and Right **arrow keys are friends**

  - What follows is a list of instructions meant to make AGM 2023 an experience.   
  
  - Find and Keep your four digit THTA ID handy. (*recheck Inbox for Lana's email assigning it to you*)

  - To get a quick view of what's ahead Press **"O"**

  - Or use **Right Arrow** key for the next slide. 
...
---
## About Biana Edwards (today's Facilitator)
